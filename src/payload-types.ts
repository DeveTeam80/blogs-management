...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'user-approvals': UserApprovalsSelect<false> | UserApprovalsSelect<true>;
...
export interface Post {
  ...
  tags?:
    ...
    | null;
  /**
   * Featured post appears highlighted on the blog page.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "user-approvals".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'user-approvals';
        value: number | UserApproval;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "user-approvals_select".
 */
export interface UserApprovalsSelect<T extends boolean = true> {
  userId?: T;
  seenBy?: T;
  name?: T;
  email?: T;
